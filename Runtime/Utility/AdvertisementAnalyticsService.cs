...
namespace KinDzaDzaGames.AdvertisementPlugin
{
    ...
    public static class AdvertisementAnalyticsService
    {
        ...
        public static void SendAdsShowSuccess(AdsType advertismentType) => SendEvent($"Ad Shown", GetActionAdsDataJson(advertismentType, Action.Show));
        public static void SendAdsImpression(AdsType advertismentType) => SendEvent($"Ad Shown", GetActionAdsDataJson(advertismentType, Action.Impression));
